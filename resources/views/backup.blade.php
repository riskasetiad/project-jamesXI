...
<head>
    ...
    <script>
        window.addEventListener('scroll', () => {
            ...
            if (sectionTop < windowHeight && sectionTop > 0) {
                ...
                newartText.style.color = 'rgb(100, 102, 107)'; // Kembali ke abu-abu netral
            }
        });
    </script>
    ...
    <style>
        ...
        .scroll-container::after {
            ...
            bottom: 0;
            width: 100px;
            /* Adjust width to control gradient intensity */
            pointer-events: none;
        }
...
<body class="bg-black text-white flex flex-col justify-between min-h-screen">
        ...
        <div class="relative w-full h-full min-h-screen bg-black bg-opacity-50 backdrop-blur-lg p-6">
            <div class="relative w-full h-[570px] bg-zinc-950 p-6  rounded-3xl border border-white/0 overflow-hidden">
                ...
                <div class="absolute inset-0 flex justify-center items-center">
                    <h1 class="text-[19.5rem] font-bold bg-black opacity-15 hover:text-lime-500 hover:opacity-100">
                        NEWART</h1>
                </div>
    ...
    <section id="about">
        ...
        {{-- 3 --}}
        <div class="relative w-full h-full min-h-screen bg-black bg-opacity-50 backdrop-blur-lg p-6 mt-10">
            <div class="relative w-full h-full bg-white bg-opacity-10 p-6  rounded-3xl border border-white/0">
                ...
                <p
                    class="text-6xl font-bold bg-gradient-to-l from-black via-black to-gray-200 bg-clip-text text-transparent blur-sm mt-10 pl-10
            transform transition-transform duration-300 hover:translate-x-3">
                ...
                <p
                    ...
                    “I treated design as all meanings of my life”</p>
                <p
                    class="text-3xl text-gray-400 pl-10 mt-3 transform transition-transform duration-300 hover:translate-x-3">
                    I have personally designed and led more than 100+ of projects, and I have extensive experience
                    and strong execution capabilities in experience design. </p>
                <div class="flex items-center space-x-4 pl-10 mt-5">
                    <div
                        class="flex items-center px-6 py-3 bg-black/20 rounded-full text-lg border border-white-2 font-medium text-white">
                        <div class="bg-lime-500 rounded-full p-2 mr-3">
                            <svg class="w-5 h-5 text-black" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <p class="text-lg text-gray-400 pl-20 mt-3">
     ...
     <div class="bg-black text-white p-6">
            <div class="bg-gradient-to-b from-transparent overflow-hidden via-transparent to-lime-500/20 p-6 rounded-lg">
                <div class="flex justify-between items-center py-4 border-b border-gray-800">
                    <div class="group flex justify-between items-center w-full">
                        <div
                            ...
                            <p class="bg-gradient-to-l from-stone-900 to-stone-700 text-white py-2 px-6 text-lg rounded-full">72+</p>
                            <div>
                            <img src="image/uI4ui27mbDHa4aRUCFrJXCG7tGc.jpg"
                                class="absolute -bottom-44 left-[800px] transform -translate-x-1/2 rotate-45 group-hover:rotate-0 opacity-0 group-hover:opacity-70 transition-opacity duration-500 ease-in-out w-96 h-96">
                        </div>
                        </div>
                ...
                <div class="flex justify-between items-center py-4 border-b border-gray-800">
                    <div class="group flex justify-between items-center w-full">
                        <div
                            ...
                            <p class="bg-gradient-to-l from-stone-900 to-stone-700 text-white py-2 px-6 text-lg rounded-full">43+</p>
                            <div>
                ...
                <div class="flex justify-between items-center py-4 border-b border-gray-800">
                    <div class="group flex justify-between items-center w-full">
                        <div
                            ...
                            <p class="bg-gradient-to-l from-stone-900 to-stone-700 text-white py-2 px-6 text-lg rounded-full">16+</p>
                            <div>
                ...
                <div class="flex justify-between items-center py-4 border-b border-gray-800">
                    <div class="group flex justify-between items-center w-full">
                        <div
                            ...
                            <p class="bg-gradient-to-l from-stone-900 to-stone-700 text-white py-2 px-6 text-lg rounded-full">32+</p>
                            <div>
...
<script>
    ...
    container.addEventListener('mouseenter', () => {
        image.classList.remove('rotate-45'); // Pastikan rotasi awal 0 saat hover
    });

    container.addEventListener('mouseleave', () => {
        image.classList.add('rotate-0'); // Tambah rotasi saat keluar
        setTimeout(() => {
            image.classList.remove('opacity-70'); // Sembunyikan gambar setelah rotasi
        }, 500); // Sesuaikan durasi rotasi dengan durasi transisi
    });
</script>
    ...
    <section id="works">
        <div class="bg-black text-white p-6">
            ...
            <div class="transform opacity-0 transition-all duration-700 ease-out" id="project-text">
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                // Saat elemen masuk viewport, tambahkan class untuk animasi
                document.getElementById('project-text').classList.add('translate-y-0', 'opacity-100');
            }x
        });
    }, { threshold: 0.1 }); // Mengatur kapan observer aktif, di sini saat 10% elemen terlihat

    observer.observe(document.getElementById('project-text'));
</script>
<style>/* Tambahkan style di Tailwind untuk animasi saat elemen masuk viewport */
#project-text {
    transform: translateY(50px); /* Awal berada di bawah */
    opacity: 0;
}

#project-text.translate-y-0 {
    transform: translateY(0); /* Saat animasi aktif, bergerak ke posisi aslinya */
    ...
    <section id="blogs">
        ...
        <div class="flex justify-center items-center space-x-4 pl-10 mt-5">
            <div
                ...
                <p class="transition-transform duration-500 ease-in-out group-hover:-translate-x-10">More Info</p>
            </div>
        </div>
    ...
    <div class="sticky bottom-6 z-50 w-full flex justify-center">
